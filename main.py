    ...
    Archive Tool B1rc3
    ==================
    A fast CLI utility to inspect files and directories straight from the terminal.
...
return results
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="A fast CLI utility to inspect files and directories straight from the terminal.")
